...
# url = 'https://ekaterinburg.hh.ru/vacancies/programmist'#input()
# responce = requests.get(url, headers = {'User-Agent': UserAgent().random})
# soup = bs(responce.text, 'lxml')
# nums_pages = []
...
#     url = f"https://ekaterinburg.hh.ru/vacancies/programmist?page={num_page}"
#     get_prices(url)

# avg_price = sum(all_prices)/len(all_prices)
# print(int(avg_price), 'руб.')
